...
HDFS_DIR=/lestat/db_lestat/feedback
TMP_DIR=/data/tmp/feedback/tmp
FB_CHECK=$TMP_DIR/fb.check
FILE_LOCK=$TMP_DIR/hdfs_fb.lock
...
RPS_LOGS=`find $LOCAL_DIR -name "fbfile*" ! -wholename "*.bz2" -type f -mmin +10`
