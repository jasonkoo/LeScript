...
HDFS_DIR=/lestat/apperror
TMP_DIR=/data/tmp/apperror/tmp
APPERROR_CHECK=$TMP_DIR/apperror.check
FILE_LOCK=$TMP_DIR/hdfs_apperror.lock
...
sid=$(getSid $fileName)
HDFS_DATE_DIR=$HDFS_DIR/$sid/$dateStr
...
RPS_LOGS=`find $LOCAL_DIR -name "apperror*" ! -wholename "*.bz2" -type f -mmin +10`
