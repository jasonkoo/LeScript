...
HDFS_DIR=/lestat/appfeedback
TMP_DIR=/data/tmp/appfeedback/tmp
APPFB_CHECK=$TMP_DIR/appfb.check
FILE_LOCK=$TMP_DIR/hdfs_appfb.lock
...
RPS_LOGS=`find $LOCAL_DIR -name "appfb*" ! -wholename "*.bz2" -type f -mmin +10`
