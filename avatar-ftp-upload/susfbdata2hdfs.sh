...
HDFS_DIR=/lestat/susfeedback
TMP_DIR=/data/tmp/susfeedback/tmp
SUSFB_CHECK=$TMP_DIR/susfb.check
FILE_LOCK=$TMP_DIR/hdfs_susfb.lock
...
RPS_LOGS=`find $LOCAL_DIR -name "susfb*" ! -wholename "*.bz2" -type f -mmin +10`
